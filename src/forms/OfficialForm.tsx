...
export const OfficialForm = ({
    ...
    const [data, setData] = React.useState<IOfficial>(
        official || {
            name: '',
            derbyName: '',
            insurance: 'no',
            ...
            {data.vrdlMember !== 'yes' && (
                <>
                    ...
                    <p style={{ textAlign: 'center' }}>
                        <strong>
                            Officials without a league affiliation or insurance
                            cannot be involved in scrimmages
                        </strong>
                    </p>
                </>
            )}
