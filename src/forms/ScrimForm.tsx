    ...
    return (
        <VStack>
            ...
            <table>
                ...
                <tbody>
                    {data.officials!.map((e, i) => (
                        <tr key={`${e.officialId.id}${e.positionId.id}`}>
                            <td width="50%">
                                <Viewer
                                    name="derbyName"
                                    subName="name"
                            ...
                            <td width="50%">
                                <Viewer name="name" item={e.positionId} />
                            </td>
                            <td width="45px">
                ...
                <tfoot>
                    <tr>
                        <td colSpan={3}>
                            ...
                            {adding && (
                                <AddPosition
                                    onCancel={() => showAdding(false)}
                                    onAccept={handleAddPosition}
                                />
                            )}
                        </td>
                    </tr>
            ...
            <textarea onChange={e => handleNoteChange(e.target.value)}>
                {data.notes}
            </textarea>
